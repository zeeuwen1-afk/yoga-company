 ...
 * Stripe, en CRM-notities zijn interne aantekeningen van Yoga Companie, geen
...
export async function GET() {
  ...
  const bestand = {
    toelichting:
      "Dit bestand bevat alle persoonsgegevens die Yoga Companie van je bewaart. Je betaalgegevens staan bij Stripe en niet bij ons.",
    ...
    berichten: (berichten.data ?? []).map((rij) => ({
      van: rij.sender_id === gebruiker.id ? "jij" : "Yoga Companie",
      bericht: rij.body,
