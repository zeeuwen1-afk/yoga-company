...
import type { MenuIngang } from "@/content/menubalk";
import { cn } from "@/lib/utils";

/**
 * De balk bovenaan elke pagina.
 *
 * Krijgt zijn ingangen aangereikt in plaats van ze zelf op te halen: dit is
 * een clientcomponent — het menu op de telefoon klapt open en dicht — en die
 * kan niet in de database kijken. `SiteHeader` ernaast doet dat en geeft het
 * resultaat door.
 */
export function Menubalk({ items }: { items: MenuIngang[] }) {
