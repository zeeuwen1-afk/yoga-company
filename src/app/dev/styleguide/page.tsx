...
const colors = [
  {
    token: "--color-green",
    value: "#2F4239",
    use: "nachtgroen, primair — koppen, knoppen, footer",
  },
  {
  ...
  { token: "--color-sage", value: "#A9BCA1", use: "salie, secundair accent" },
  { token: "--color-sand", value: "#DCCBA8", use: "zand, warm accent" },
  {
    token: "--color-sand-light",
    value: "#E7DCC2",
    use: "zand licht, warm accent",
  },
  { token: "--color-paper", value: "#F9F7F1", use: "paginaachtergrond" },
  {
    token: "--color-cream",
    value: "#F2EEE4",
    use: "tintvlakken en tekst op groen",
  },
  { token: "--color-ink", value: "#2F4239", use: "bodytekst" },
  { token: "--color-muted", value: "#667268", use: "bijschriften" },
  { token: "--color-line", value: "#D8D3C4", use: "lijnen, kaders" },
  {
