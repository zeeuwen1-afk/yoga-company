 ...
 *
 * Gericht aan collega's, niet aan cursisten. Twee dingen moeten hier eerlijk
 * staan, want ze bepalen of iemand meedoet:
 *
 *  1. **Het geld blijft van jou.** Je int zelf, op je eigen rekening. Dit
 *     platform ziet dat geld niet en houdt het niet vast.
 *  2. **Wat het kost als een klant bij een ander komt.** Dat is de enige
 *     verplichting die je aangaat, en het bedrag hoort er meteen bij te staan.
 *
...
export const DOCENTEN_VOORWAARDEN_TITEL = "Wat je nodig hebt om mee te doen";

export const DOCENTEN_VOORWAARDEN = `
<ul>
