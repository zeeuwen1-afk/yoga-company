...
insert into content_blocks (page_key, block_key, kind, value)
values ('home', 'hero_link', 'text', '{"text":"/lessen"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('home', 'hero_link_twee', 'text', '{"text":"/opleidingen"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('home', 'aanbod_knop', 'text', '{"text":"Bekijk het volledige aanbod"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;

insert into content_blocks (page_key, block_key, kind, value)
values ('home', 'aanbod_link', 'text', '{"text":"/opleidingen"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('home', 'cta_knop', 'text', '{"text":"Neem contact op"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('bedrijfsyoga', 'knop_link', 'text', '{"text":"#aanvraag"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('onderwijs', 'knop_link', 'text', '{"text":"#aanvraag"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('sportclubs', 'knop_link', 'text', '{"text":"#aanvraag"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('portfolio', 'cta_knop', 'text', '{"text":"Neem contact op"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('over-ons', 'cta_titel', 'text', '{"text":"Benieuwd of het klikt?"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;

insert into content_blocks (page_key, block_key, kind, value)
values ('over-ons', 'cta_tekst', 'text', '{"text":"De beste manier om erachter te komen is het gesprek. Stel je vraag; we reageren meestal binnen twee werkdagen."}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;

insert into content_blocks (page_key, block_key, kind, value)
values ('over-ons', 'cta_knop', 'text', '{"text":"Neem contact op"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;

insert into content_blocks (page_key, block_key, kind, value)
values ('over-ons', 'cta_link', 'text', '{"text":"/contact"}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
...
insert into content_blocks (page_key, block_key, kind, value)
values ('menubalk', 'ingangen', 'richtext', '{"items":[{"titel":"Yoga Company Academy","href":"/opleidingen","onder":""},{"titel":"200-uurs Yogaopleiding","href":"/opleidingen/200-uurs-yogaopleiding","onder":"Yoga Company Academy"},{"titel":"200-uurs Yin Yoga Specialist","href":"/opleidingen/200-uurs-yin-yoga-specialist","onder":"Yoga Company Academy"},{"titel":"Losse modules","href":"/opleidingen#losse-modules","onder":"Yoga Company Academy"},{"titel":"Waar de Academy voor staat","href":"/opleidingen/academy","onder":"Yoga Company Academy"},{"titel":"Je opleiding registreren","href":"/opleidingen/academy#registreren","onder":"Yoga Company Academy"},{"titel":"Workshops","href":"/workshops","onder":""},{"titel":"Privéyoga","href":"/lessen/tarieven#prive","onder":""},{"titel":"Voor organisaties","href":"/bedrijfsyoga","onder":""},{"titel":"Bedrijven","href":"/bedrijfsyoga","onder":"Voor organisaties"},{"titel":"Sportclubs","href":"/sportclubs","onder":"Voor organisaties"},{"titel":"Onderwijs","href":"/onderwijs","onder":"Voor organisaties"},{"titel":"Trainingen","href":"/trainingen","onder":""},{"titel":"Over ons","href":"/over-ons","onder":""},{"titel":"Contact","href":"/contact","onder":""}]}'::jsonb)
on conflict (page_key, block_key) do update set
  kind = excluded.kind,
  value = excluded.value;
