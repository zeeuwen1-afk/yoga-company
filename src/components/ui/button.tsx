...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg font-semibold whitespace-nowrap transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary: "bg-primary text-primary-foreground hover:bg-accent-light",
        secondary:
          "border border-line-strong bg-transparent text-green-dark hover:bg-hover",
        ghost: "text-green-dark hover:bg-hover",
